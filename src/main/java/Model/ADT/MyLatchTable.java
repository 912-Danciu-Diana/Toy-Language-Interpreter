    ...
    public void put(int key, int value) throws Exception {
        synchronized (this) {
            if (!latchTable.containsKey(key)) {
                ...
                throw new Exception(String.format("Latch table already contains the key %d!", key));
            }
        }
    }
    ...
    public int get(int key) throws Exception {
        synchronized (this) {
            if (latchTable.containsKey(key)) {
                ...
                throw new Exception(String.format("Latch table doesn't contain the key %d!", key));
            }
        }
    }
